    ...
    <>
      ...
      >
        ...
        <form onSubmit={savereg} encType="multipart/form-data">
          ...
          <div className="mb-3">
            <div className={img.length!=0?"image":""} id="img" >{img.length!=0?(<img src={img}/>):""}</div>
          ...
          <div className="mb-3">
            ...
            {props.role=="admin"?(<label htmlFor="" style={{width:"100%",textAlign:"center"}}>Do have account: <Link to="/login" style={{textDecoration:"none"}}>Login</Link></label>):""} 
            {}
          </div>
        </form>
      </div>
